...
PAYRIFF_APPROVE_URL = config("PAYRIFF_APPROVE_URL", "order-approved")
PAYRIFF_CANCEL_URL = config("PAYRIFF_CANCEL_URL", "order-cancelled")
PAYRIFF_DECLINE_URL = config("PAYRIFF_DECLINE_URL", "order-declined")
